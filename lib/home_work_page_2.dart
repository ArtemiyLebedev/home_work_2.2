            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text(
                      'Калькулятор пиццы', style: TextStyle(fontSize: 30,
                        color:Color.fromRGBO(149, 111, 56, 1.0), fontWeight: FontWeight.w600
                    )),
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    Text(
                        'Выберите параметры', style: TextStyle(fontSize: 20,
